...
|-------------+------------------------------------------------------+--------------------------------------------|
| Copy        | Creates a new element that is "equal to the old one, | Uses every time you insert an element,     |
| Constructor | but that can safely be destructed without affecting  | except when using an emplace method.       |
|             | the old one.                                         |                                            |
|-------------+------------------------------------------------------+--------------------------------------------|
| Move        | Creates a new element by moving all content from a   | Used when the source element is an rvalue, |
| Constructor | source element to the new element.                   | and will be destroyed after the            |
|             |                                                      | construction of the new element; also used |
|             |                                                      | when a vector grows in size, for example.  |
|-------------+------------------------------------------------------+--------------------------------------------|
| Assignment  | Replaces the contents of an element with a copy of   | Used every time you modify an element.     |
| Operator    | the source element.                                  |                                            |
|-------------+------------------------------------------------------+--------------------------------------------|
| Move        | Replaces the contents of an element by moving all    | Used when the source element is an rvalue, |
| Assignment  | content from a source element.                       | and will be destroyed after the assignment |
| Operator    |                                                      | operation.                                 |
|-------------+------------------------------------------------------+--------------------------------------------|
...
|-------------+------------------------------------------------------+--------------------------------------------|
| operator<   | Determines if one element is less than another.      | Required for keys in associative           |
|             |                                                      | containers and for certain operations,     |
...
|-------------------------+---------------------+-----------------------------------------------------------------|
| Read (Input Iterator)   | operator++          | Provides read-only access, forward only (no operator-- to move  |
|                         | operator*           | backward).                                                      |
|                         | operator->          | Iterators can be assigned, copied, and compared for equality.   |
|                         | copy constructor    |                                                                 |
|                         | operator=           |                                                                 |
|                         | operator==          |                                                                 |
|                         | operator!=          |                                                                 |
...
|                         | operator*           | Iterators can be assigned, but cannot be compared for equality. |
|                         | copy constructor    | Note the absence of operator->.                                 |
|                         | operator=           |                                                                 |
|-------------------------+---------------------+-----------------------------------------------------------------|
| Forward Iterator        | Capabilities of     | Provides read/write access, forward only.                       |
|                         | input iterators,    | Iterators can be assigned, copied, and compared for equality.   |
|                         | plus: default       |                                                                 |
|                         | constructor         |                                                                 |
|-------------------------+---------------------+-----------------------------------------------------------------|
