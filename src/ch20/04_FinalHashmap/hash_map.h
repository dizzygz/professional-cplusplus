...
namespace ProCpp {
  ...
  class const_hash_map_iterator
      : public std::iterator<std::bidirectional_iterator_tag, typename HashMap::value_type> {
...
namespace ProCpp {
  ...
  template <typename HashMap>
  const_hash_map_iterator<HashMap>::const_hash_map_iterator(size_t bucket, list_iterator_type listIt,
                                                            const HashMap* inHashmap)
      : mBucketIndex(bucket), mListIterator(listIt), mHashmap(inHashmap) {}

  // Return the actual element
  template <typename HashMap>
  const typename const_hash_map_iterator<HashMap>::value_type& const_hash_map_iterator<HashMap>::operator*()
      const {
  ...
  template <typename Key, typename T, typename Compare, typename Hash>
  template <typename InputIterator>
  hash_map<Key, T, Compare, Hash>::hash_map(InputIterator first, InputIterator last, const Compare& comp,
  ...
  // Initializer list constructor
  template <typename Key, typename T, typename Compare, typename Hash>
  hash_map<Key, T, Compare, Hash>::hash_map(std::initializer_list<value_type> il, const Compare& comp,
                                            size_type numBuckets, const Hash& hash)
      : mSize(0), mComp(comp), mHash(hash) {
    if (numBuckets == 0) {
      throw std::invalid_argument("Number of buckets must be positive");
  ...
  typename hash_map<Key, T, Compare, Hash>::ListType::iterator hash_map<Key, T, Compare, Hash>::findElement(
      const key_type& x, size_type& bucket) {
  ...
  template <typename Key, typename T, typename Compare, typename Hash>
  typename hash_map<Key, T, Compare, Hash>::iterator hash_map<Key, T, Compare, Hash>::find(
      const key_type& x) {
    size_t bucket;
  ...
  template <typename Key, typename T, typename Compare, typename Hash>
  typename hash_map<Key, T, Compare, Hash>::const_iterator hash_map<Key, T, Compare, Hash>::find(
  ...
  template <typename Key, typename T, typename Compare, typename Hash>
  std::pair<typename hash_map<Key, T, Compare, Hash>::iterator,
  ...
  template <typename Key, typename T, typename Compare, typename Hash>
  std::pair<typename hash_map<Key, T, Compare, Hash>::const_iterator,
  ...
  template <typename Key, typename T, typename Compare, typename Hash>
  typename hash_map<Key, T, Compare, Hash>::size_type hash_map<Key, T, Compare, Hash>::count(
      const key_type& x) const {
  ...
  template <typename Key, typename T, typename Compare, typename Hash>
  std::pair<typename hash_map<Key, T, Compare, Hash>::iterator, bool> hash_map<Key, T, Compare, Hash>::insert(
      const value_type& x) {
    size_t bucket;
  ...
  template <typename Key, typename T, typename Compare, typename Hash>
  typename hash_map<Key, T, Compare, Hash>::iterator hash_map<Key, T, Compare, Hash>::insert(
  ...
  template <typename Key, typename T, typename Compare, typename Hash>
  typename hash_map<Key, T, Compare, Hash>::iterator hash_map<Key, T, Compare, Hash>::emplace_hint(
  ...
  template <typename Key, typename T, typename Compare, typename Hash>
  typename hash_map<Key, T, Compare, Hash>::size_type hash_map<Key, T, Compare, Hash>::erase(
      const key_type& x) {
    size_t bucket;
  ...
  template <typename Key, typename T, typename Compare, typename Hash>
  typename hash_map<Key, T, Compare, Hash>::iterator hash_map<Key, T, Compare, Hash>::erase(
      iterator position) {
  ...
  template <typename Key, typename T, typename Compare, typename Hash>
  typename hash_map<Key, T, Compare, Hash>::iterator hash_map<Key, T, Compare, Hash>::erase(iterator first,
                                                                                            iterator last) {
  ...
  template <typename Key, typename T, typename Compare, typename Hash>
  typename hash_map<Key, T, Compare, Hash>::value_compare hash_map<Key, T, Compare, Hash>::value_comp()
      const {
