...
bool Spreadsheet::inRange(int val, int upper) { return (val >= 0 && val < upper); }
...
int Spreadsheet::getId() const { return mId; }

SCell::SpreadsheetCell() : mValue(0) {}

SCell::SpreadsheetCell(double initialValue) { set(initialValue); }
